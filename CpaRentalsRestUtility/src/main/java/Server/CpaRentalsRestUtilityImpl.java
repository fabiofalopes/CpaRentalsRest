...
public class CpaRentalsRestUtilityImpl {
    ...
    @POST
    @Path("/cancelReserva") // Path for the cancelReserva method
    ...
    @GET
    @Path("/getReservasTable") // Path for the cancelReserva method
     // Specifies the response content type
    ...
    @GET
    @Path("/getDailyOcupationTable") // Path for the cancelReserva method
     // Specifies the response content type
  ...
  */
	...
	*/
    ...
    @POST
    @Path("/login") // Path for the cancelReserva method
     // Specifies the response content type
    ...
    @POST
    @Path("/registerUser") // Path for the cancelReserva method
     // Specifies the response content type
    ...
    @GET
    @Path("/getReservationById") // Path for the cancelReserva method
     // Specifies the response content type
    ...
    @GET
    @Path("/getReservationsByUserId") // Path for the cancelReserva method
     // Specifies the response content type
    ...
    @POST
    @Path("/addReservation") // Path for the cancelReserva method
     // Specifies the response content type
    ...
    @POST
    @Path("/cancelReservation") // Path for the cancelReserva method
    // Specifies the response content type
